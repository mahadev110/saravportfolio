            ...
            <div class="banner_inner d-flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						<h2>ML Studio Project Details</h2>
						<div class="page_link">
							<a href="index.phpl">Home</a>
							<a href="mlstudio.php">ML Studio</a>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="portfolio_right_text">
								<h4>Empowering AI Innovation</h4>
								<p>Accelerate machine learning workflows with cutting-edge tools, optimized data pipelines, and scalable AI solutions. </p>
								<ul class="list">
